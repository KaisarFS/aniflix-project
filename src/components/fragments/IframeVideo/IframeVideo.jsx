    ...
    return(
        <>
            <div className="w-full relative pb-[56.25%] mb-3">
                <iframe className="absolute w-full h-full" src={qualityHandler(streamUrl)} title="video" allowFullScreen webkitallowfullscreen="true" mozallowfullscreen="true" frameBorder="0" width="448" height="252"></iframe>
            </div>
        </>
    )
}
